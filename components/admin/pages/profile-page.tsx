      ...
      <div className="bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-500 rounded-2xl shadow-xl overflow-hidden">
        <div className="px-6 md:px-8 py-12 md:py-16">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-white">{adminData.fullName}</h1>
              <p className="text-blue-100 text-lg mt-2">{adminData.department}</p>
              <p className="text-blue-100/80 text-sm">Admin ID: {adminData.adminId}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-slate-800/50 hover:bg-slate-800/80 border border-slate-700/50 hover:border-blue-500/50 rounded-xl p-5 transition-all duration-300">
            ...
            <p className="text-white text-lg font-semibold ml-11">{adminData.fullName}</p>
          </div>
          ...
          <div className="bg-slate-800/50 hover:bg-slate-800/80 border border-slate-700/50 hover:border-blue-500/50 rounded-xl p-5 transition-all duration-300">
            ...
            <p className="text-white text-lg font-semibold ml-11">{adminData.firstName}</p>
          </div>
          ...
          <div className="bg-slate-800/50 hover:bg-slate-800/80 border border-slate-700/50 hover:border-blue-500/50 rounded-xl p-5 transition-all duration-300">
            ...
            <p className="text-white text-lg font-semibold ml-11">{adminData.middleName}</p>
          </div>
          ...
          <div className="bg-slate-800/50 hover:bg-slate-800/80 border border-slate-700/50 hover:border-blue-500/50 rounded-xl p-5 transition-all duration-300">
            ...
            <p className="text-white text-lg font-semibold ml-11">{adminData.lastName}</p>
          </div>
          ...
          <div className="bg-slate-800/50 hover:bg-slate-800/80 border border-slate-700/50 hover:border-blue-500/50 rounded-xl p-5 transition-all duration-300">
            ...
            <p className="text-white text-lg font-semibold ml-11 truncate">{adminData.email}</p>
          </div>
          ...
          <div className="bg-slate-800/50 hover:bg-slate-800/80 border border-slate-700/50 hover:border-blue-500/50 rounded-xl p-5 transition-all duration-300">
            ...
            <p className="text-white text-lg font-semibold ml-11">{adminData.department}</p>
          </div>
        </div>
      </div>
