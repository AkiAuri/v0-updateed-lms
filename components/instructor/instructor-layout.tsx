...
export default function InstructorLayout({
  ...
  const renderPage = () => {
    switch (currentPage) {
      case "profile":
        return <InstructorProfile instructorName={instructorName} />
      case "subjects":
        return <InstructorSubjects onSubjectClick={handleSubjectClick} />
      case "attendance":
        return <InstructorAttendance onSubjectClick={(subject, tabType) => handleSubjectClick(subject, tabType)} />
      case "grades":
        return <InstructorGrades onSubjectClick={(subject, tabType) => handleSubjectClick(subject, tabType)} />
      case "inbox":
        ...
        return (
          <div className="min-h-screen bg-gradient-to-b from-background to-background pt-24 px-4">
            <div className="max-w-7xl mx-auto">
              <h1 className="text-4xl font-bold text-foreground mb-2">Welcome back, {instructorName}!</h1>
